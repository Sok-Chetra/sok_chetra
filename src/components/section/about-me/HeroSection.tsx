    ...
    return (
        <section className="relative flex min-h-[80svh] items-center justify-center px-4 py-24 transition-all duration-500">
            <div className="relative z-10 max-w-3xl text-center">
                <Enter as="h1" step={1} className="mb-6 text-5xl font-bold md:text-7xl">
                ...
                <Enter step={3} className="mx-auto max-w-lg">
                ...
                <Enter step={4} className="mt-8 flex justify-center">
                    <Link
                        href="/portfolio"
