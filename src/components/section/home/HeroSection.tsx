...
export default function HeroSection() {
    return (
        <section className="relative h-auto min-[321px]:h-[100dvh]  flex items-center justify-center py-30 min-[321px]:py-0 px-4 min-[321px]:px-6 lg:px-8 inset-0  transition-all duration-500">
